...
namespace RLWE_Toolkit {
	namespace Main_Classes {
		class RingLweCryptographyField;
	}
}
...
@version 1.0
*/
class RLWE_Toolkit::Main_Classes::RingLweCryptographyField : public std::enable_shared_from_this<RingLweCryptographyField>
{
public:
...
private:
	...
	template<typename T> using avt_uptr = std::unique_ptr < RLWE_Toolkit::Transformations::AbstractVectorTransformation<T> >;
...
using RLWE_Toolkit::Main_Classes::RingLweCryptographyField;
