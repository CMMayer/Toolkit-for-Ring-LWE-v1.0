...
namespace RLWE_Toolkit {
	...
	//forward declarations of friend functions for RLWE_Toolkit::Main_Classes::RingLweCryptographyElement.
	//necessary because of the namespacing
	bool add(RLWE_Toolkit::Main_Classes::RingLweCryptographyElement& x, 
		RLWE_Toolkit::Main_Classes::RingLweCryptographyElement const& a, 
		RLWE_Toolkit::Main_Classes::RingLweCryptographyElement const& b);

	bool mult(RLWE_Toolkit::Main_Classes::RingLweCryptographyElement& x,
		RLWE_Toolkit::Main_Classes::RingLweCryptographyElement const& a,
		RLWE_Toolkit::Main_Classes::RingLweCryptographyElement const& b);
}
...
@version 1.0
*/
class RLWE_Toolkit::Main_Classes::RingLweCryptographyElement
{
public:
...
private:
	...
	friend bool RLWE_Toolkit::add(RingLweCryptographyElement& x, RingLweCryptographyElement const& a, RingLweCryptographyElement const& b);
	friend bool RLWE_Toolkit::mult(RingLweCryptographyElement& x, RingLweCryptographyElement const& a, RingLweCryptographyElement const& b);
...
namespace RLWE_Toolkit {
	...
	*/
	void sampleGaussiansInK_RR(real_vec& x, RLWE_Toolkit::Main_Classes::RingLweCryptographyField const& field, 
...
std::ostream& operator<<(std::ostream& out, RingElement const& elmt);
